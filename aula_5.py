...
if __name__ == "__main__":  # se o arquivo estiver sendo executado diretamente
    ...
    print("\nTeste 5 - aula5")
    print(resultado)
    save_json("teste_saida_aula5.json", resultado)




print("\nProbabilidade Empirica de Temperatura - Cidade de Moscou (30 dias)")
temperatura_media = [
    -8, -7, -6, -5, -4, -3, -2, -1, 0, 1,
    2, 3, 1, 0, -1, -2, -3, -4, -5, -6,
    -7, -5, -3, -1, 0, 2, 1, -2, -4, -6
...
temperatura_abaixo_zero = 0

for t in temperatura_media:
    if (t < 0):
        temperatura_abaixo_zero =+1

# print("\nProbabilidade de ficar a base de zero")
# print(temperatura_abaixo_zero/len(temperatura_media))



print("\nProbabilidade empírica de Precipitação - Cidade de Moscou (30 dias)")
precipitacao_mm = [
    5, 0, 2, 0, 0, 8, 10, 0, 3, 1,
    0, 0, 4, 6, 0, 0, 0, 7, 2, 0,
    1, 0, 0, 5, 9, 0, 0, 3, 0, 0
]

dias_sem_chuva = precipitacao_mm.count(0)
total_dias = len(precipitacao_mm)

# print("Probabilidade de não chover")
# print(dias_sem_chuva / total_dias)
