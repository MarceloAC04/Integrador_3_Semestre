...
if __name__ == "__main__":  # se o arquivo estiver sendo executado diretamente
    ...
    print("\nResultado - aula3")
    save_json("saida_aula3.json", resultado)
    print(resultado)
...
# Lista de pontos da La Liga
pontos_la_liga = [
    95, 85, 81, 76, 68, 60, 57, 53, 49, 46,
    45, 43, 41, 41, 40, 40, 38, 33, 21, 21
]

print("\nTeste - tabela de distribuição de frequências")
tabela = frequency_table(pontos_la_liga, 3)
print(tabela)

print("\nTeste - percentil")
per = percentile(pontos_la_liga, 0.25)
print("P25="+str(per))   
per = percentile(pontos_la_liga, 0.50)
print("P50="+str(per))   
per = percentile(pontos_la_liga, 0.75)
print("P75="+str(per))

print("\nTeste - Quartis")
quar = quartiles(pontos_la_liga)
print(quar)

print("\nTeste - Decis")
deci = deciles(pontos_la_liga)
print(deci)


print("\nTeste - tabela de distribuiçao de contigencia")
resultado = [
    "Vitória", "Empate", "Derrota", "Vitória", "Vitória",
    "Empate", "Derrota", "Vitória", "Empate", "Derrota",
]

local = [
    "Casa", "Casa", "Fora", "Casa", "Fora",
    "Fora", "Casa", "Casa", "Fora", "Fora",
]

tabela = contingency_table(resultado, local, 2)
print(tabela)
