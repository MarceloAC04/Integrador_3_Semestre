...
if __name__ == "__main__":  # se o arquivo estiver sendo executado diretamente
    ...
    print("\nTeste - correlação - Cidade de Manaus (Jan a dez)")
    temperatura_maxima = [34, 34, 34, 33, 33, 34, 35, 37, 38, 38, 37, 35]
    precipitacao = [309, 300, 383, 363, 313, 173, 115, 106, 128, 166, 199, 295] 
    r= pearson_correlation(temperatura_maxima, precipitacao)
    print("Correlação ="+str(r))

    print('Resultado - Temperatura Maxima')
    print(" ")
    print("Media = "+str(safe_mean(temperatura_maxima)))
    print("Mediana = "+str(safe_median(temperatura_maxima)))
    print("Amplitude = "+str(amplitude(temperatura_maxima)))
    print("Variancia = "+str(safe_variance(temperatura_maxima)))
    print("Desvio Padrão = "+str(safe_std(temperatura_maxima)))
    print(" ")

    print('Resultado - Precipitacao')
    print(" ")
    print("Media = "+str(safe_mean(precipitacao)))
    print("Mediana = "+str(safe_median(precipitacao)))
    print("Amplitude = "+str(amplitude(precipitacao)))
    print("Variancia = "+str(safe_variance(precipitacao)))
    print("Desvio Padrão = "+str(safe_std(precipitacao)))
    print(" ")
