...
if __name__ == "__main__":  # se o arquivo estiver sendo executado diretamente
    ...
    print("\nTeste 6 - aula6")
    print(resultado)
    save_json("teste_saida_aula6.json", resultado)


# # Distribuição Normal
# normal = [10.2, 9.8, 10.5, 10.1, 9.9, 10.3, 10.0]
# print("\nTeste: log-verossmilhança - Normal")
# log_ver=normal_loglik(normal)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(normal)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(normal)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(normal)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(normal)
# print("binomial="+str(log_ver))


# # Distribuição Exponencial
# exponencial = [0.5, 1.2, 0.3, 2.1, 1.8, 0.7, 3.0]
# print("\nTeste: log-verossmilhança - Exponencial")
# log_ver=normal_loglik(exponencial)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(exponencial)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(exponencial)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(exponencial)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(exponencial)
# print("binomial="+str(log_ver))

# # Distribuição Uniforme
# uniforme = [1, 2, 3, 4, 5, 6, 7]
# print("\nTeste: log-verossmilhança - Uniforme")
# log_ver=normal_loglik(uniforme)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(uniforme)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(uniforme)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(uniforme)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(uniforme)
# print("binomial="+str(log_ver))

# # Distribuição de Poisson
# poisson = [2, 3, 1, 4, 0, 2, 5]
# print("\nTeste: log-verossmilhança - Poisson")
# log_ver=normal_loglik(poisson)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(poisson)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(poisson)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(poisson)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(poisson)
# print("binomial="+str(log_ver))

# # Distribuição Binomial
# binomial = [4, 5, 6, 3, 7, 5, 4]
# print("\nTeste: log-verossmilhança - Binomial")
# log_ver=normal_loglik(binomial)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(binomial)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(binomial)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(binomial)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(binomial)
# print("binomial="+str(log_ver))

# # Distribuição de Bernoulli
# bernoulli = [0, 1, 1, 0, 1, 0, 1]
# print("\nTeste: log-verossmilhança - Bernoulli")
# log_ver=normal_loglik(bernoulli)
# print("normal="+str(log_ver))
# log_ver=exponential_loglik(bernoulli)
# print("exponencial="+str(log_ver))
# log_ver=poisson_loglik(bernoulli)
# print("poisson="+str(log_ver))
# log_ver=bernoulli_loglik(bernoulli)
# print("bernoulli="+str(log_ver))
# log_ver=binomial_loglik(bernoulli)
# print("binomial="+str(log_ver))
