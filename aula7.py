...
if __name__ == "__main__":  # se o arquivo estiver sendo executado diretamente
    ...
    print("\nTeste 7 - aula7")
    print(resultado)
    save_json("teste_saida_aula7.json", resultado)


inflacao = [2.5, 3.1, 2.9, 3.5, 14.2, 3.8, 4.1, 3.9, 4.5, 4.2, 3.7, 4.0]

print('Antes da normalização')
print("Media = "+str(safe_mean(inflacao)))
print("Mediana = "+str(safe_median(inflacao)))
print("Amplitude = "+str(amplitude(inflacao)))
print("Variancia = "+str(safe_variance(inflacao)))
print("Desvio Padrão = "+str(safe_std(inflacao)))

print('')

print('Depois da normalização Min-Max')
inflacao_min_max = min_max_normalize(inflacao)
print("Media = "+str(safe_mean(inflacao_min_max)))
print("Mediana = "+str(safe_median(inflacao_min_max)))
print("Amplitude = "+str(amplitude(inflacao_min_max)))
print("Variancia = "+str(safe_variance(inflacao_min_max)))
print("Desvio Padrão = "+str(safe_std(inflacao_min_max)))

print('')

print('Depois da normalização Z-score')
inflacao_z_score = z_score_standardize(inflacao)
print("Media = "+str(safe_mean(inflacao_z_score)))
print("Mediana = "+str(safe_median(inflacao_z_score)))
print("Amplitude = "+str(amplitude(inflacao_z_score)))
print("Variancia = "+str(safe_variance(inflacao_z_score)))
print("Desvio Padrão = "+str(safe_std(inflacao_z_score)))

# juros = [5.0, 5.5, 5.2, 6.0, 15.5, 6.5, 7.0, 6.8, 7.5, 7.2, 6.5, 6.8]
# print('')

# print('Antes da normalização')
# print("Media = "+str(safe_mean(juros)))
# print("Mediana = "+str(safe_median(juros)))
# print("Amplitude = "+str(amplitude(juros)))
# print("Variancia = "+str(safe_variance(juros)))
# print("Desvio Padrão = "+str(safe_std(juros)))

# print('')

# print('Depois da normalização Min-Max')
# juros_min_max = min_max_normalize(juros)
# print("Media = "+str(safe_mean(juros_min_max)))
# print("Mediana = "+str(safe_median(juros_min_max)))
# print("Amplitude = "+str(amplitude(juros_min_max)))
# print("Variancia = "+str(safe_variance(juros_min_max)))
# print("Desvio Padrão = "+str(safe_std(juros_min_max)))

# print('')

# print('Depois da normalização Z-score')
# juros_z_score = z_score_standardize(juros)
# print("Media = "+str(safe_mean(juros_z_score)))
# print("Mediana = "+str(safe_median(juros_z_score)))
# print("Amplitude = "+str(amplitude(juros_z_score)))
# print("Variancia = "+str(safe_variance(juros_z_score)))
# print("Desvio Padrão = "+str(safe_std(juros_z_score)))

# print("")

# # Correlação
# correlacao = pearson_correlation(inflacao, inflacao_min_max)
# print(f"Correlação: {correlacao}")
# print("")

# # Metodo IQR
# inflacao_iqr = iqr_outliers(inflacao)
# print(f"IQR: {inflacao_iqr}")
